# coding: utf8
#Select destination family and then on an family/element you would like to move.
...
def connect_to():
    ...
    # -------------------------------------------------
    try:
        moved_manager = get_connector_manager(moved_element)
        target_manager = get_connector_manager(target_element)
