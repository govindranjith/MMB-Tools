...
# -------------------------------------------------
# LEFT TURN VECTOR ✅ (Z × Forward)
# -------------------------------------------------
left_vector = XYZ.BasisZ.CrossProduct(horizontal_forward)

if left_vector.IsZeroLength():
    logger.error("Failed to compute left-hand direction.")
    script.exit()
...
try:
    if is_duct:
        ...
        logger.info("✅ Elbow LEFT and new duct created.")
        ...
        doc.Create.NewElbowFitting(c1, c2)
        logger.info("✅ Elbow LEFT and new pipe created.")
